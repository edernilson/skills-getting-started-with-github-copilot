...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for practices and league matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Track and Field": {
        "description": "Training for sprint, distance, jumps and throws; compete in meets",
    ...
    "Art Workshop": {
        ...
        "max_participants": 18,
        "participants": ["sophia.a@mergington.edu", "jack@mergington.edu"]
    },
    "Choir": {
